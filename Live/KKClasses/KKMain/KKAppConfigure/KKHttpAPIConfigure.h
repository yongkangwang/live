...
//hd
#define purl [NSString stringWithFormat:@"%@%@",[KKUserDefaults valueForKey:KKLoginNetworkStr],@"/api/"]
//hd
...
#define KKSocketRocket @""
//1V1
#define kkpurl [NSString stringWithFormat:@"%@%@",[KKUserDefaults valueForKey:KKLoginNetwork1V1Str],@"/appapi"]
